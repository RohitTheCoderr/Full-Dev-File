...
// NOTE: -  HERE note that we create a two function with a same name sumNum it's ok but if we create function with same  name in arrow and function expression then error=> SyntaxError: Identifier 'sumNum' has already been declared 
//     yuo can check upper function to make arrow and function expression 

//  check here also
// let hello =function()
// {
//     // console.log("hello rohit");
//     return "hello rohit and aryan"
// }
// console.log(hello());
